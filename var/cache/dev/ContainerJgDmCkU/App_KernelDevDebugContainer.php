...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.app.swagger_ui' => ['privates', 'security.firewall.map.context.app.swagger_ui', 'getSecurity_Firewall_Map_Context_App_SwaggerUiService', true],
            ...
            'security.firewall.map.context.app.swagger_ui' => '?',
            ...
            yield 'security.firewall.map.context.app.swagger_ui' => ($this->privates['.security.request_matcher.mYljB3Z'] ?? ($this->privates['.security.request_matcher.mYljB3Z'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/doc')));
            yield 'security.firewall.map.context.login' => ($this->privates['.security.request_matcher.DZoY9_l'] ?? ($this->privates['.security.request_matcher.DZoY9_l'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/v1/auth')));
            yield 'security.firewall.map.context.register' => ($this->privates['.security.request_matcher.PEUIOmG'] ?? ($this->privates['.security.request_matcher.PEUIOmG'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/v1/register')));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'security.app.swagger_ui._indexed_authenticators' => [
